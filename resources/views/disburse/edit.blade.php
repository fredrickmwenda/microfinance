              ...
              <div class="card-body">
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="customer_name" value="{{$disbursement->disbursedTo->first_name}} {{$disbursement->disbursedTo->last_name}}" readonly>
                  </div>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="customer_phone" value="{{$disbursement->disbursedTo->phone}}" readonly>
                    </div>
                  </div>
                </div>
                <div class="form-row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="loan_amount" placeholder="Loan Amount"  value ="{{$disbursement->loan->amount}}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                           <!--customer phone number-->
                            ...
                            <input type="text" class="form-control" name="loan_interested"  placeholder="Loan Interest" value ="{{$disbursement->loan->interest}}" readonly>
                        </div>
                    </div>
                  </div>
                ...
                <div class="form-row">
                  <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group ">
                        ...
                        <!--get old $disbursement->payment_method if there is any-->
                        @php
                            $disbursement->payment_method = old('payment_method', $disbursement->payment_method);
                            
                        @endphp
                        <!--set the old value to the select field-->
                        <select class="form-control" id="payment_method" name="payment_method" required>
                            <option {{ old('payment_method') == $disbursement->payment_method ? 'selected' : '' }} value="{{ $disbursement->payment_method }}">{{ $disbursement->payment_method }}</option>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control" id="disburse_amount" name="amount" value="{{ old('amount', $disbursement->disbursement_amount) }}" placeholder="Disburse Amount" required>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="description" name="description" rows="3" placeholder="Description">{{ old('description', $disbursement->description) }}</textarea>
                </div>
