...
<head>
    ...
    <title> Loan Rejection Email</title>
    <meta name="description" content="Loan Rejection Email.">
    <style type="text/css">
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        Hello {{$details['customer_name']}}, your loan has been rejected.
                                        </h1>
                                        <span
                                        ...
                                        Your loan amount of {{$details['loan_amount']}} has been rejected.
                                        Your loan was rejected because {{$details['rejection_reason']}}.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
