    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
              <h4>{{__('Prehistoric Loan (*Loans Paid But not in System)')}}</h4>
            </div>
            @if ($errors->any())
            ...
            @endif
            <form method="POST" action="{{ route('loans.prehistoric.store') }}" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
                ...
                <div class="form-row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group">
                        <!--The day of the month when the loan is due-->                       
                      <label>{{ __('Creation Date') }}</label>
                      <input type="date" class="form-control" name="loan_creation_date" placeholder="Creation Date" required>
                    </div>
                  </div>
                </div>
                <div class="form-row">  
                  <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group">
                        <!--The day of the month when the loan is due-->                       
                      <label>{{ __('Due Date / Payment Date') }}</label>
                      <input type="date" class="form-control" name="due_date" placeholder="Due Date" required>
                    </div>
                  </div>
                </div>
