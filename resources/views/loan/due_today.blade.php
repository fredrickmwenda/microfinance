...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>'Due Today Loans List'])
@endsection
                ...
                <table class="table table-striped" id="loanPendingTable-2">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <!-- disbursed_date column is a date type column so we can use the format method to format the date-->
