    ...
    <div class="card-body py-20">
        ...
        <div class="mw-lg-950px mx-auto w-100">
                ...
                <div class="d-flex flex-column gap-7 gap-md-10">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-7 gap-md-10 fw-bold">
                        ...
                        <div class="flex-root d-flex flex-column">
                            ...
                            <span class="fs-5">03 April, 2023</span>
                        </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <!--begin::Thumbnail-->
                                                <a href="/metronic8/demo6/../demo6/apps/ecommerce/catalog/edit-product.html" class="symbol symbol-50px">
                                                    <span class="symbol-label" style="background-image:url(/metronic8/demo6/assets/media//stock/ecommerce/1.gif);"></span>
                                                </a>
                                                <!--end::Thumbnail-->
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <div class="fs-7 text-muted">Delivery Date: 03/04/2023</div>
                                                </div>
                                                <!--end::Title-->
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <!--begin::Thumbnail-->
                                                <a href="/metronic8/demo6/../demo6/apps/ecommerce/catalog/edit-product.html" class="symbol symbol-50px">
                                                    <span class="symbol-label" style="background-image:url(/metronic8/demo6/assets/media//stock/ecommerce/100.gif);"></span>
                                                </a>
                                                <!--end::Thumbnail-->
            ...
            <div class="d-flex flex-stack flex-wrap mt-lg-20 pt-13">
                ...
                <!-- begin::Action-->
                <a href="/metronic8/demo6/../demo6/apps/invoices/create.html" class="btn btn-primary my-1">Create Invoice</a>
                <!-- end::Action-->
            </div>
            <!-- end::Footer-->
        </div>
