        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center font-weight-bold my-2">
                    ...
                    <!--begin::Item-->
                    <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                    <span class="text-white text-hover-white opacity-50">Permissions</span>
                    <!--end::Item-->
                </div>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div class="card card-custom gutter-b ">
        <div class="card-header">
            <div class="card-title">
                <h5 class="font-14">List of Permission</h5>
            </div>
        </div>
        <div class="card-body">
                        ...
                        @foreach ($permissions as $permission)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a  data-toggle="tooltip" data-placement="top" title="Edit" href="{{ route('permissions.edit', $permission->id) }}" class="btn btn-sm btn-info pull-left" style="margin-right: 3px;"><i class="fa fa-pencil-square-o"></i> </a>
